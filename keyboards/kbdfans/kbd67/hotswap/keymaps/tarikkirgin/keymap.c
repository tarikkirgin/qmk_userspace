...
[0] = LAYOUT(
  ...
  KC_LGUI, KC_LALT, RHYP_T(KC_ESC),                KC_SPC,                   KC_RALT, MO(1),                KC_LEFT, KC_DOWN, KC_RGHT),
...
[1] = LAYOUT(
  ...
  _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, QK_BOOT, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,  KC_INS, _______,
