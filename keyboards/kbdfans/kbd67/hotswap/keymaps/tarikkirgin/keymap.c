...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, KC_F15, KC_UP, KC_F16, KC_F17, KC_F18, _______, _______, _______, _______, _______, _______, _______, QK_LOCK,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_F19, TG(_GAME), _______, _______, _______, _______, _______, _______, _______, KC_SCRL,
        _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, QK_BOOT, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_INS,
